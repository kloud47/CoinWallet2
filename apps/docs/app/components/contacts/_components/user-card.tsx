  ...
  return (
    <>
      <a
        ...
        className="h-[110px] w-[100px] m-1 duration-200 rounded-2xl flex flex-col items-center p-2 justify-between hover:bg-foreground/20 hover:cursor-pointer"
      >
        {!imgUrl && name && (
        ...
        <div className="text-[#fff] font-[300]">{children}</div>
      </a>
    </>
  );
};
